    ...
    const fetchRequests = async (status = currentTab) => {
        ...
        try {
            if (status === 'APPROVED') {
                ...
                setRequests([
                    ...(approvedResponse?.data?.data?.requests || approvedResponse?.data?.requests || []),
                    ...(returningResponse?.data?.data?.requests || returningResponse?.data?.requests || []),
                    ...(overdueResponse?.data?.data?.requests || overdueResponse?.data?.requests || [])
                ]);
            } else {
